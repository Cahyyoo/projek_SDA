...
function renderQueue() {
    ...
    queue.forEach((element) => {
        ...
        queueElement.textContent = `Elemen ${element.value} (Prioritas: ${element.priority})`;
...
enqueueButton.addEventListener('click', () => {
    ...
    const priority = prompt("Masukkan prioritas elemen (angka lebih kecil berarti lebih tinggi prioritas):");
    const newElement = {
        value: currentNumber,
    ...
    statusMessage.textContent = `Elemen ${newElement.value} dengan prioritas ${newElement.priority} berhasil ditambahkan!`;
    currentNumber++;
});
...
dequeueButton.addEventListener('click', () => {
    ...
    statusMessage.textContent = `Elemen ${removedElement.value} dengan prioritas ${removedElement.priority} berhasil dihapus!`;
});
